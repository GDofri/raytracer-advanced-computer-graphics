...
public:
     ...
     * the border region.
     */
    Bitmap *toBitmap(float splatScale) const;
     ...
     */
    void splat(const Point2f &pos, const Color3f &value);
...
protected:
    ...
    Eigen::Array<Color3f, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> m_splat;

...
/**
 * \brief Calculate the balance heuristic for two PDFs
 * @param nf Number of samples from the first distribution
 * @param fPdf Probability density function value of the first distribution
 * @param ng Number of samples from the second distribution
 * @param gPdf Probability density function value of the second distribution
 * @return
 */
